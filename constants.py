...
COMMAND_TYPE_TO_STRUCTS = {
    "NORM_COMMAND": [(PIECE_TOKEN, VRP_TOKEN, NUMBER_TOKEN, NORM_OP_TOKEN, NUMBER_TOKEN),
                     (PIECE_TOKEN, VRP_TOKEN, NUMBER_TOKEN, NORM_OP_TOKEN),
                     (PIECE_TOKEN, NUMBER_TOKEN, NORM_OP_TOKEN, NUMBER_TOKEN),
                     (PIECE_TOKEN, NUMBER_TOKEN, NORM_OP_TOKEN),
                     (PIECE_TOKEN, EXTEND_POSITION_TOKEN, NORM_OP_TOKEN, NUMBER_TOKEN),
                     (PIECE_TOKEN, EXTEND_POSITION_TOKEN, NORM_OP_TOKEN),
                     (PIECE_TOKEN, NORM_OP_TOKEN, NUMBER_TOKEN),
                     (PIECE_TOKEN, NORM_OP_TOKEN)],
    ...
    "CHECKMATE_COMMAND": [(PIECE_TOKEN, VRP_TOKEN, NUMBER_TOKEN, CHECKMATE_TOKEN),
                          ...
                          (PIECE_TOKEN, VRP_TOKEN, NUMBER_TOKEN, CHECKMATE_TOKEN, NUMBER_TOKEN),
                          (PIECE_TOKEN, NUMBER_TOKEN, CHECKMATE_TOKEN, NUMBER_TOKEN),
                          (PIECE_TOKEN, EXTEND_POSITION_TOKEN, CHECKMATE_TOKEN, NUMBER_TOKEN),
                          (PIECE_TOKEN, CHECKMATE_TOKEN, NUMBER_TOKEN),
                          ],
